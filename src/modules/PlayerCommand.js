...
var playerCommands = {
    ...
    minion1: function (args) {
        if (this.playerTracker.userRole != UserRoleEnum.ADMIN && this.playerTracker.userRole != UserRoleEnum.MODER && this.playerTracker.userRole != UserRoleEnum.JOKER) {
            this.writeLine("ERROR: access denied!");
            return;
        }
        var add = args[1];
